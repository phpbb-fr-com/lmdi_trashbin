...
class listener implements EventSubscriberInterface
{
	...
	protected $auth;
	protected $phpbb_log;
	protected $fid;    // Global property because of function build_url
	protected $tid;    // Global property because of function build_url
	...
	{
		// Moderator with right to move or delete and we aren't in the trashbin
		if ($this->can_build_url())
		{
	...
	{
		$this->fid = (int) $event['forum_id'];
		$this->tid = (int) $event['topic_id'];
